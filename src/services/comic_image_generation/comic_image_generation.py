...
from src.utils.text_processing.chapter_info_hander import extract_chapter_info
...
class ComicImageGeneration:
    ...
    def __init__(self, config_path: str = "src/services/comic_image_generation/config.yaml"):
        ...
        self.storyboards_prompt_dir = self.config.get("comic_image_generation", {}).get("paths", {}).get("storyboards_prompt_dir", "data/storyboards_prompt/")
