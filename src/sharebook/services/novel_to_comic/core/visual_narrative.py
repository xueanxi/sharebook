...
from sharebook.services.novel_to_comic.config.prompts import VISUAL_PROMPT
from sharebook.services.novel_to_comic.config.processing_config import VISUAL_GENERATOR_CONFIG, MAX_RETRIES, RETRY_DELAY
