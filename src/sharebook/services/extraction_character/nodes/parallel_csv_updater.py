...
class ParallelCSVUpdater:
    ...
    def __init__(self, csv_path: str, llm_config_path: str = "sharebook/config/llm_config.py", extraction_config_path: str = "sharebook/services/extraction_character/config.yaml", max_workers: int = 6):
        """
