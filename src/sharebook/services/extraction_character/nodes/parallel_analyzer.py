...
class ParallelCharacterAnalyzer:
    ...
    def __init__(self, llm_config_path: str = "sharebook/config/llm_config.py", extraction_config_path: str = "sharebook/services/extraction_character/config.yaml", max_workers: int = 6):
        """
        初始化并行角色分析节点
